...
class TR:
    ...
    ecash__block_height: str = "Block height:"
    ecash__confirm_sign_stake: str = "Confirm eCash stake"
    ecash__expiration_time: str = "Expiration time:"
    ecash__is_coinbase: str = "Is coinbase:"
    ecash__master_pubkey: str = "Master public key:"
    ecash__output_index: str = "Output index:"
    ecash__transaction_id: str = "Transaction ID:"
